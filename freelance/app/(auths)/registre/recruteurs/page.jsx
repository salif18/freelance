        ...
        <LayoutPage>
            <main className={styles.auth}>
                <section className={styles.rigth}>
                    <h3>Vous cherchez des prestataires pour vos services</h3>
                    <p>
                        Bienvenue sur notre <span className="plate">plateforme</span>, un service qui permet de vous mettre
                        en contact avec les candidats prestataires à l'aide d'un seul bouton
                    </p>
                    <p>Créer votre compte et trouver vos candidat(e)s.</p>
